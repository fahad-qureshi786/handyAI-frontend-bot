                        ...
                        >
                            ...
                            <div className="w-full  max-w-md z-10">
                                ...
                                <div className="sm:text-sm xl:text-md text-gray-200 font-normal">
                                    {" "}
                                    Experience the future of food ordering with our SaaS-based food company's AI chatbot. Say goodbye to long waits and hello to instant, personalized recommendations for a delightful dining experience!
                                </div>
                            </div>
                            {/*-remove custom style*/}
